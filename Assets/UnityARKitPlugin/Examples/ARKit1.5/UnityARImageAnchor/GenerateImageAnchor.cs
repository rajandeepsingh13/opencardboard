	...
	void UpdateImageAnchor(ARImageAnchor arImageAnchor)
	{
		...
		if (arImageAnchor.referenceImageName == referenceImage.imageName) {
            if (arImageAnchor.isTracked)
            {
                ...
                imageAnchorGO.transform.localScale = new Vector3(0.005f, 0.005f, 0.005f);
                imageAnchorGO.transform.position = UnityARMatrixOps.GetPosition(arImageAnchor.transform) + new Vector3(0, 0, 0);
                imageAnchorGO.transform.rotation = UnityARMatrixOps.GetRotation(arImageAnchor.transform) * Quaternion.Euler(0, 0, 0);
            }
