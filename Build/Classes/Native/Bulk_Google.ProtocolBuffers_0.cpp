...
IL_0024:
	{
		bool L_6 = CodedInputStream_get_IsAtEnd_m3022129809(__this, /*hidden argument*/NULL);
		if (!L_6)
		{
			goto IL_0039;
		}
...
IL_0039:
	{
		...
		uint32_t L_11 = CodedInputStream_ReadRawVarint32_m2491433814(__this, /*hidden argument*/NULL);
	...
	{
		InvalidProtocolBufferException_t2498581859 * L_15 = InvalidProtocolBufferException_InvalidTag_m4139780452(NULL /*static, unused*/, /*hidden argument*/NULL);
		IL2CPP_RAISE_MANAGED_EXCEPTION(L_15, NULL, CodedInputStream_ReadTag_m4000905079_RuntimeMethod_var);
	}
...
extern "C" IL2CPP_METHOD_ATTR bool CodedInputStream_BeginArray_m3587638847 (CodedInputStream_t2502120507 * __this, uint32_t ___fieldTag0, bool* ___isPacked1, int32_t* ___oldLimit2, const RuntimeMethod* method)
{
	...
	{
		uint32_t L_5 = CodedInputStream_ReadRawVarint32_m2491433814(__this, /*hidden argument*/NULL);
	...
	}
	{
		...
		int32_t L_8 = V_0;
		int32_t L_9 = CodedInputStream_PushLimit_m2130578355(__this, L_8, /*hidden argument*/NULL);
